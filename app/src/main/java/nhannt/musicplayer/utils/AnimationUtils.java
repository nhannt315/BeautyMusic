...
public class AnimationUtils {
    ...
    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public static void revealHide(Context context, final View view, final AnimationListener listener) {
        int cx = view.getWidth() - dpToPx(context, 56);
        int cy = dpToPx(context, 23);
        float startRadius = (float) Math.hypot(view.getWidth(), view.getHeight());
