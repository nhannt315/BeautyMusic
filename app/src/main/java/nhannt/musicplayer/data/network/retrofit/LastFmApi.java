...
import nhannt.musicplayer.data.network.retrofit.model.Artist;
import nhannt.musicplayer.data.network.retrofit.model.Artistmatches;
import nhannt.musicplayer.data.network.retrofit.model.Result;
import nhannt.musicplayer.data.network.retrofit.model.ResultDetail;
